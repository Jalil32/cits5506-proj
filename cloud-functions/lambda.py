...
# Configuration
IMPORTANT_LABELS = ['Person', 'Human', 'Vehicle', 'Car', 'Dog', 'Cat']
MIN_CONFIDENCE = 70
...
def lambda_handler(event, context):
    ...
    try:
        ...
        if important_detections:
            ...
            try:
                # Create a message with detected objects
                ...
                if frame_url:
                    sms_message += f"View image: {frame_url} "
                if video_url:
                    sms_message += f"View video: {video_url}"
