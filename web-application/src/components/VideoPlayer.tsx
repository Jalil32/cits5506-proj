	...
	return (
		...
		>
			<CardContent className="p-2">
				<div className="w-full h-24 bg-zinc-800 rounded-md mb-2 relative flex items-center justify-center">
				...
				<div className="flex flex-col items-center space-y-2">
					<span
						className="text-xs text-zinc-400 truncate w-full text-center"
						title={formatDate(video.lastModified)}
					>
						{formatDate(video.lastModified)}
					</span>
					<span
						className="text-xs text-zinc-500 truncate w-full text-center"
